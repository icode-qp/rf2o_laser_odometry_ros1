  ...
  CLaserOdometry2D()
{
  ...
  pn.param<std::string>("laser_frame_id",laser_frame_id, "/velod");
...
bool CLaserOdometry2DNode::setLaserPoseFromTf()
{
  ...
  try
  {
    ...
    //tf_listener.lookupTransform(base_frame_id, last_scan.header.frame_id, ros::Time(0),ros::Duration(5.0),transform);
